package vell.bibi.vsigner.view.pullable;
...
public class PullToRefreshLayout extends RelativeLayout
{
	...
	// 控制允许的pull方向， 默认两个方向都可以
	private boolean pullDownAble = true;
	private boolean pullUpAble = true;
	
	public boolean isPullDownAble() {
		return pullDownAble;
	}

	public void setPullDownAble(boolean pullDownAble) {
		this.pullDownAble = pullDownAble;
	}
	...
	public void setPullUpAble(boolean pullUpAble) {
		this.pullUpAble = pullUpAble;
	}
	...
	{
		if(state == DONE || state == INIT) return;
	...
	{
		canPullDown = pullDownAble;
		canPullUp = pullUpAble;
	}
